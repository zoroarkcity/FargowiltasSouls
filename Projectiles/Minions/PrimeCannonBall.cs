    ...
    public class PrimeCannonBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num619 = 0; num619 < 2; num619++)
            {
                ...
                int num620 = Gore.NewGore(projectile.position, default(Vector2), Main.rand.Next(61, 64));
                Main.gore[num620].velocity *= scaleFactor9;
                Gore gore97 = Main.gore[num620];
                gore97.velocity.X = gore97.velocity.X + 1f;
                Gore gore98 = Main.gore[num620];
                gore98.velocity.Y = gore98.velocity.Y + 1f;
                num620 = Gore.NewGore(projectile.position, default(Vector2), Main.rand.Next(61, 64));
                Main.gore[num620].velocity *= scaleFactor9;
