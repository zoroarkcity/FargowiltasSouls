            ...
            if (Main.netMode != 1)
            {
                ...
                else
                {
                    ...
                    if (p != -1)
                    {
                        ...
                        for (int i = 0; i < 10; i++)
                        {
                            Projectile.NewProjectile(projectile.Center, speed.RotatedBy(Math.PI / 5 * i), mod.ProjectileType("AbomSickle"), projectile.damage, projectile.knockBack, projectile.owner);
                            Projectile.NewProjectile(projectile.Center, speed.RotatedBy(Math.PI / 5 * i), mod.ProjectileType("AbomDeathraySmall"), projectile.damage, 0f, projectile.owner);
                        }
                    }
                }
            }
