...
namespace FargowiltasSouls.Projectiles.MutantBoss
{
    public class MutantDeathray3 : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D20 = mod.GetTexture("Projectiles/Deathrays/PhantasmalDeathray2");
            Texture2D texture2D21 = mod.GetTexture("Projectiles/Deathrays/PhantasmalDeathray3");
