...
这将使敌人造成1.5倍伤害, 同时受到5倍伤害");
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (SoulConfig.Instance.GetValue(SoulConfig.Instance.RedDevilMinion))
            {
            ...
            fargoPlayer.AddPet(SoulConfig.Instance.LeviPet, hideVisual, calamity.BuffType("Levi"), calamity.ProjectileType("Levi"));
        }
